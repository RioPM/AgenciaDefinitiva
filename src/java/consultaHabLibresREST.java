 ...
 * @author Rio
 */
@WebServlet(urlPatterns = {"/consultaHabLibresREST"})
public class consultaHabLibresREST extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet consultaHabLibresREST</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet consultaHabLibresREST at " + request.getContextPath() + "</h1>");
            ...
            We_hotel_JerseyClient client = new We_hotel_JerseyClient();
            String ocupades = client.consulta_libres(String.class, String.valueOf(idHotel), String.valueOf(fecha));
            out.println("<br>");
