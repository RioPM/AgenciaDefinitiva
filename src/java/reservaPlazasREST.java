 ...
 * @author Rio
 */
@WebServlet(urlPatterns = {"/reservaPlazasREST"})
public class reservaPlazasREST extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet reservaPlazasREST</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet reservaPlazasREST at " + request.getContextPath() + "</h1>");
            ...
            VolClient client = new VolClient();
            String ocupades = client.reserva_plaza(String.class, String.valueOf(idVuelo), String.valueOf(fecha));
            out.println("<br>");
